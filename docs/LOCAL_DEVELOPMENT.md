...
export UTAH_CLAW_ENFORCE=0
export UTAH_CHRONO_ENFORCE=0
export UTAH_OMNI_GLASS_STREAM=0
...
$env:UTAH_CLAW_ENFORCE = "0"
$env:UTAH_CHRONO_ENFORCE = "0"
$env:UTAH_OMNI_GLASS_STREAM = "0"
