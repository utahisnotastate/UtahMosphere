...
| `UTAH_LAZARUS_KEXEC_ENFORCE` | `1` | kexec laadimine/taaskäivitus (`0` = arendus) |
| `UTAH_LAZARUS_KEXEC_KERNEL` | `/boot/vmlinuz-verified` | Kinnitatud taastamistuum |
| `UTAH_LAZARUS_KEXEC_INITRD` | `/boot/initramfs-verified` | Kinnitatud initramfs |
