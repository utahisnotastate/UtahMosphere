...
UtahMosphere OS **v34.0 Infrastructure d'attestation à distance** — ancres de confiance souveraines : registre global des citations matérielles, épinglage CA RA-TLS, liaison biométrique au TPM.
...
Tous les éléments de la feuille de route v28.0 sont **implémentés** en v34.0 (épinglage CA RA-TLS distant, registre des citations matérielles).
