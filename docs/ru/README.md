...
Добро пожаловать в центр документации UtahMosphere OS. **v30.0 DHT-Federated Attestation** — суверенная цепочка доверия: TPM Locker, RA-TLS mesh-аттестация, mempool Океании и Voice Bridge с автоподписанием nonce. Материалы организованы по **ролям аудитории**, **практическим руководствам**, **готовым рецептам** и **стартовым проектам**.
...
## Ключевые характеристики UtahMosphere OS v30.0

- **Суверенное периферийное облако** на Python — порт `8999`, `build: omega-build-v30-federated-attested`
...
- [Матрица возможностей](CAPABILITY_MATRIX.md) — статус реализации v30.0
