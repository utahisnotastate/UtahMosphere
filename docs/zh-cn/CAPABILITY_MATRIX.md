...
UtahMosphere OS **v28.0 TPM-Hardened Attested** — 主权信任链已全部完成。
...
| 端点 | 方法 | 状态 | 说明 |
|------|------|------|------|
| `/health` | GET | **已实现** | `build: omega-build-v28-attested` + 完整 attestation 快照 |
...
| **Genesis ISO v28** | **已实现** | `utah_genesis_v28.iso` |
