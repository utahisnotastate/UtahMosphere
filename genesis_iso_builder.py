...
ISO_OUTPUT = Path(os.environ.get("ISO_OUTPUT", REPO_DIR / "utah_genesis_v26.iso"))
ISO_LABEL = os.environ.get("ISO_LABEL", "UTAH_GENESIS_V26")
...
def stage_sovereign_stack(staging: Path):
    ...
    readme = """UtahMosphere Genesis ISO v26.0
================================
